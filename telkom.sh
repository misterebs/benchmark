...
speed() {
  ...
  speed_test '' 'Normal Node'
	speed_test '1369' 'Telkom Balikpapan'
  speed_test '1370' 'Telkom Banjarmasin'
  speed_test '7582' 'Telkom Jakarta'
  speed_test '2233' 'Telkom Surabaya 1'
  speed_test '37344' 'Telkom Surabaya 2'
