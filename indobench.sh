#!/usr/bin/env bash
#
# Description: Auto test download & I/O speed & network to Indonesia script
#
# Copyright (C) 2017 - 2017 Misterebs <ekoboedhisantoso@gmail.com>
#
...
speed() {
  ...
  speed_test '' 'Normal Node'
	speed_test '797' 'Biznet B'
  speed_test '7582' 'Telkom B'
  speed_test '7959' 'Hutchison B'
  speed_test '282' 'CBN B'
  speed_test '4402' 'Axiata B'
  speed_test '4764' 'Indosat B'
  speed_test '11118' 'MyRepublic B'
  speed_test '4210' 'Smartfren B'
  speed_test '13954' 'MNC B'
  speed_test '6612' 'Firstmedia B'
  speed_test '5356' 'BoltSuper4G B'
  speed_test '2233' 'Telkom L'
  speed_test '4802' 'Firstmedia L'
  speed_test '14395' 'Hutchison L'
  speed_test '6493' 'Smartfren L'
  speed_test '7370' 'Moratel L'
  speed_test '12532' 'CitraNet  AB'
  speed_test '10370' 'JogjaMedia AB'
  speed_test '7127' 'GMedia H'
  speed_test '1372' 'Telkom H'
  speed_test '11284' 'Hypernet H'
  speed_test '7378' 'Moratel BP'
  speed_test '1371' 'Telkom BP'
  speed_test '12041' 'SolNet BP'
  speed_test '8207' 'NAP BP'
  speed_test '7668' 'MediaLink BP'
  speed_test '7702' 'Medialink BM'
  speed_test '13342' 'Dashnet BM'
  speed_test '7584' 'Telkom BM'
  speed_test '14274' 'Hutchison BM'
  speed_test '7583' 'Telkom BK'
  speed_test '7369' 'Moratel BK'
  speed_test '13901' 'Hutchison BG'
  speed_test '7585' 'Telkom BG'
  speed_test '13874' 'Hutchison DK'
  speed_test '7581' 'Telkom DK'
  speed_test '6131' 'HyperNet DK'
  speed_test '6109' 'DNET DK'
  speed_test '8689' 'Biznet DK'
  speed_test '7099' 'Neuviz DK'
